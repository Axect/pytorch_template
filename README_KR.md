...
├── hyperbolic_lr.py       # HyperbolicLR + ExpHyperbolicLR 스케줄러
...
| `optimizer` | 옵티마이저 클래스 경로 (`torch.optim.*`, `splus.SPlus`, 사용자 정의 지원) |
| `scheduler` | 스케줄러 클래스 경로 (`torch.optim.lr_scheduler.*`, `hyperbolic_lr.*`, 사용자 정의 지원) |
...
- [HyperbolicLR](https://github.com/Axect/HyperbolicLR) - 쌍곡선 곡선 기반 학습률 스케줄링.
- [SPlus](https://github.com/kvfrans/splus) - SPlus 옵티마이저.
